        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> 한 놈</span>
              <div class="count">3</div>
              <span class="count_bottom"><i class="green">4% </i> Survey Name</span>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-6 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> 안 한 놈</span>
...
<!--           <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Recent Notice <small>Sessions</small></h2>
 ...
 <!--  End of Recent Notice -->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <!-- Start to do list -->
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>To Do Survey <small>Sample tasks</small></h2>
                      <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
